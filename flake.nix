{
  ...
  inputs = {
    ...
    # nixpkgs.url = "git+file:///home/joshua/files/repos/nixpkgs?ref=nixos-unstable-personal";
    ...
    hyprland.url = "github:hyprwm/Hyprland?rev=0b215c5f246d3fde6c023e78b3e3579f7498c172";
