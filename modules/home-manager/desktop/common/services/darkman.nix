...
mkIf (cfg.enable && desktopEnabled) {
  ...
  # home.file attribute to darkman/variants/PATH.dark where PATH is the
  ...
  # original config file does not exist. We create a new home.file entry
  ...
  home.file = listToAttrs (
    concatMap (
      ...
      (concatMap (
        ...
        in
        [
          (nameValuePair absPath { target = mkForce ".config/darkman/variants/${path}.dark"; })
